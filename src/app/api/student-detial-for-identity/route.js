...
import { UploadImage } from "@/lib/cloudnary"; // Ensure this is correctly configured
...
export async function POST(request) {
    ...
    try {
        ...
        const uploadFile = async (file) => {
            ...
            return await UploadImage(fileBuffer.toString("base64"), file.type); // Ensure UploadImage accepts base64 and mimeType
        };
        ...
        // Generate ID Number and academic years
